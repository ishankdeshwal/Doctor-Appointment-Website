...
function Myprofile() {
  ...
  return userData && (
    <div  className="max-w-lg flex flex-col gap-2 text-sm">
      ...
      <div>
        <p className="text-sm text-neutral-600 mt-3 underline">CONTACT INFORMATION</p>
      ...
      <div>
        <p className="text-sm text-neutral-600 mt-5 underline">BASIC INFORMATION</p>
        <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700">
          <p>Gender:</p>
          {
            isEdit?
      ...
      <div className="mt-10 ">
        {
          isEdit?
          <button className="border px-5 py-3 hover:bg-primary hover:text-white border-primary text-sm rounded-full" onClick={updateUserProfileData}>
            Save Information
          </button>
          : <button className="border px-10 py-3 hover:bg-primary hover:text-white border-primary text-sm rounded-full" onClick={()=>setisEdit(true)}>
            Edit
          </button>
        }
      </div>
